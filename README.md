...
En mi caso, lo llevo siempre conectado con Android Auto al coche, le proporciono la dirección cercana a mi casa, cosa mías con la privacidad de datos, y siempre me aseguro de que voy a ir por el camino más rápido. Es capaz, por su forma de trabajar, de solventar atascos en tiempo real y darte una ruta más rápida a tu destino.
 ...
 _Hibridación:_ se unen los mapas, el navegador GPS y la interacción con la aplicación por parte del usuario. 
En mi caso, lo llevo siempre conectado con Android Auto al coche, le proporciono la dirección cercana a mi casa, cosa mías con la privacidad de datos, y siempre me aseguro de que voy a ir por el camino más rápido. Es capaz, por su forma de trabajar, de solventar atascos en tiempo real y darte una ruta más rápida a tu destino.
...
_Hibridación:_ en este caso podemos decir que se unen las redes sociales y los avisos de trafico, o la consulta del estado de las carreteras. Proporciona una mejora respecto de lo que seria un mapa convencional brutal. 
...
_Hibridación:_ de nuevo las redes sociales pero esta vez de una forma mas concreta. En este caso la aplicación nos permite relacionarnos con otras personas dentro de la temática de la carretera. 
...
_Hibridación:_ creo que es una de las características que mas puede ayudar a entender que es este concepto. El medio, que en principio es para la navegación por carretera nos da la posibilidad de conseguir logros con el simple hecho de usarlo.
...
_Hibridación:_ Esta integración multimodal es un claro ejemplo de hibridación de medios, donde la información de diversas plataformas se une para mejorar la experiencia del usuario en la movilidad urbana.
...
Citymapper se distingue por proporcionar información actualizada en tiempo real sobre el estado de los diferentes medios de transporte. Esta característica permite a los usuarios ajustar sus planes de viaje sobre la marcha, teniendo en cuenta retrasos, cancelaciones o cambios en el servicio. La aplicación recoge datos en vivo, asegurando que la información proporcionada sea lo más precisa y útil posible. La capacidad de Citymapper para ofrecer estos datos en tiempo real mejora significativamente la experiencia de viaje, permitiendo a los usuarios tomar decisiones informadas y eficientes.
 ...
 _Hibridación:_ como en Waze quizás esta característica no sea tan evidente, pero el que este medio proporcione información actualizada es fruto de haber incluido en ella la conectividad con distintas fuentes de información que se traduce al final en mejor planificación de viajes para el usuario.
...
_Hibridacion:_ adaptabilidad, no es un bloque estático. A ver si me explico. Aquí  se da la opción de que el usuario se "coloque" la aplicación como el quiera para usarla como el quiera. En un mapa de líneas de autobús tu no puedes mover ni cambiar nada. Si antes consultabas como ir a **_x_** lugar lo que obtenías era la linea entera de autobuses que cubría ese destino o mas se acercaba. La integración de esta característica es también hibridación.
...
**Como nos dice Manovich:** _Hoy por hoy podemos describir uno de los principales mecanismos que hay detrás de la invención de estos nuevos medios. Este mecanismo es la hibridación. Se agrupan técnicas y formatos de representación de medios físicos y electrónicos anteriores, y las nuevas técnicas de manipulación de la información y formatos de datos exclusivos del ordenador para formar nuevas combinaciones_
